        ...
        <Screen>
          ...
          {shareStep === "form" ? (
            ...
            <Card>
              ...
              <FieldLabel>Account PIN (login password)</FieldLabel>
              <Input value={pin} onChangeText={setPin} secureTextEntry autoCapitalize="none" />
      ...
      <Screen>
        ...
        <View style={{ gap: 12 }}>
          ...
          <Card>
            ...
            <Text style={{ color: colors.muted, marginBottom: 12, fontSize: 13 }}>
              Enter recipient meter, units, then confirm with your account PIN.
            </Text>
