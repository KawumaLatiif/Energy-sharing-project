# Generated by Django 3.1.2 on 2024-10-27 13:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SettingsConfirmationEmailCode',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='date created')),
                ('modify_date', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ...
                ('status', models.CharField(choices=[('USED', 'used'), ('ACTIVE', 'active')], default='ACTIVE', max_length=10)),
